...
import { 
    getSearchKeyWordGroupByCountAtTotal,
    getSearchKeyWordGroupByCountAtchilds,
    getSearchKeyWordGroupByCountAtExpandChilds
...
const { 
    ...
    getList: getSearchKeyWordGroupByCountAtTotal,
...
const loadChildrenMethod = ({ row }) => {
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            loading.value = true
            let childs = []
            getSearchKeyWordGroupByCountAtchilds(searchForm).then(res=> {
                childs = res
                resolve(childs)
            }).finally(()=>{
                loading.value = false
    ...
    return new Promise((resolve, reject) => {
        ...
        if(row.hasChild) {
            ...
            setTimeout(() => {
                ...
                getSearchKeyWordGroupByCountAtExpandChilds(searchForm).then(res=> {
                    console.log(res)
