<template>
    <el-card shadow="always" class="border-0">
        ...
        <ListHeader @create="handleCreate" @refresh="getData" v-permission="['createTag,POST']"></ListHeader>

        <!-- 表格 -->
        <el-table :data="tableData" style="width: 100%" v-loading="loading" v-permission="['getListTag,GET']">
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    ...
                    <el-popconfirm
                        ...
                        >
                        <template #reference>
                            <el-button size="small" :icon="Delete" type="danger"  v-permission="['deleteTag,DELETE']"/>
                        </template>
                    </el-popconfirm>
                </template>
            </el-table-column>
